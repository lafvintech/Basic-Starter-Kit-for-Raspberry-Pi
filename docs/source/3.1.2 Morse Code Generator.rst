...
.. tip::
   ...
   **Want to decode the programming?** Use ``nano 3.1.2_MorseCodeGenerator.c`` or ``nano 3.1.2_MorseCodeGenerator.py`` to see how text gets converted into Morse code patterns!
